...
Allow other shopping filters to be applied on Amazon, Newegg, and Walmart when
this extension is on.

### v1.2.0

Support Amazon when subcategory is used, e.g.,
`https://www.amazon.com/subcategory/s?`.
